...
interface AbstractControlTyped<T> extends AbstractControl {
  ...
  /** @member errorMessage The default error message to display if multiple errors occur */
  errorMessage: string;
...
interface FormArrayTyped<T> extends FormArray {
  // PROPS AND METHODS SPECIFIC OF FormGroup
  controls: Array<AbstractControlTyped<T>>;
  ...
  get<V = unknown>(path: Array<string | number> | string): AbstractControlTyped<V> | null;
  setValue<V>(value: V extends T[] ? V : never, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
  patchValue<V>(value: V extends Array<Partial<T>> ? V : never, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
  reset<V>(value?: V extends Array<Partial<T>> ? V : never, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
}
